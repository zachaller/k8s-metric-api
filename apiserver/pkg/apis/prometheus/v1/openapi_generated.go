...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/zachaller/k8s-metrics-api/apiserver/pkg/apis/prometheus/v1.MetricQueryRun":     schema_pkg_apis_prometheus_v1_MetricQueryRun(ref),
		"github.com/zachaller/k8s-metrics-api/apiserver/pkg/apis/prometheus/v1.MetricQueryRunList": schema_pkg_apis_prometheus_v1_MetricQueryRunList(ref),
		"github.com/zachaller/k8s-metrics-api/apiserver/pkg/apis/prometheus/v1.MetricQueryRunSpec": schema_pkg_apis_prometheus_v1_MetricQueryRunSpec(ref),
		"github.com/zachaller/k8s-metrics-api/apiserver/pkg/apis/prometheus/v1.Result":             schema_pkg_apis_prometheus_v1_Result(ref),
...
func schema_pkg_apis_prometheus_v1_MetricQueryRun(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MetricQueryRun",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/zachaller/k8s-metrics-api/apiserver/pkg/apis/prometheus/v1.MetricQueryRunSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/zachaller/k8s-metrics-api/apiserver/pkg/apis/prometheus/v1.MetricQueryRunSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_prometheus_v1_MetricQueryRunList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "MetricQueryRunList",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/zachaller/k8s-metrics-api/apiserver/pkg/apis/prometheus/v1.MetricQueryRun"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/zachaller/k8s-metrics-api/apiserver/pkg/apis/prometheus/v1.MetricQueryRun", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_prometheus_v1_MetricQueryRunSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/zachaller/k8s-metrics-api/apiserver/pkg/apis/prometheus/v1.Result"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/zachaller/k8s-metrics-api/apiserver/pkg/apis/prometheus/v1.Result"},
	}
}
